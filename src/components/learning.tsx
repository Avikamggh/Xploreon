...
const courses: Course[] = [
  {
    ...
    level: "Beginner",
    videos: [
      { id: 1, title: "Introduction to Space Exploration", url: "https://www.youtube.com/watch?v=EiTpNvksK3k", duration: "5:46" },
        ...
        <div className="text-center space-y-6">
          ...
          <div className="flex justify-between items-center mt-8 pt-6 border-t border-blue-700">
            ...
            <div className="text-center">
              ...
              <p className="font-semibold text-white">Xploreon Academy</p>
            </div>
          </div>
        </div>
      </div>
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 rounded-xl border transition-all cursor-pointer ${
                        isCurrent
                          ? "bg-gradient-to-r from-yellow-500/30 to-orange-500/30 border-yellow-400 ring-2 ring-yellow-400/50"
                          : isUnlocked 
                      ...
                      onClick={() => {
                        if (isUnlocked && !isCompleted) {
                          ...
                          alert("🔒 Complete the previous video to unlock this lesson!");
                        }
                      }}
                    >
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          {isCurrent && (
                            <p className="text-xs text-yellow-300 mt-1 font-medium">🎬 Currently Playing</p>
                          )}
                        </div>
                        <div className="ml-2">
                          {isCompleted ? (
    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {Array.from({ length: 50 }, (_, i) => (
          <div
            key={`large-${i}`}
            className="absolute rounded-full bg-blue-200 animate-ping"
            style={{
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 mb-8">
        <div className="flex flex-col md:flex-row gap-4 items-center">
          ...
          <div className="flex gap-2">
            {(["all", "beginner", "intermediate", "advanced"] as const).map((filterType) => (
              <button
                key={filterType}
              ...
              >
                {filterType === "all" ? "All Courses" : 
                 filterType === "beginner" ? "🌟 Beginner" : 
                 filterType === "intermediate" ? "⭐ Intermediate" : "🚀 Advanced"}
              </button>
            ))}
          </div>
        </div>
