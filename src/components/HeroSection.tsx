      ...
      <div className="relative z-10 w-full px-6 max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
        ...
        >
          ...
          <span className="text-sm font-medium text-white/90">
            Development Phase • First Launch 2026
          </span>
        </motion.div>

        {/* Title */}
        <motion.h1
          className="font-futuristic font-extrabold 
        ...
        {/* Subtitle */}
        <motion.p
          className="mt-4 text-xl md:text-2xl text-gray-300 max-w-2xl leading-relaxed font-light"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        {/* Stats */}
        <motion.div
          className="mt-10 grid grid-cols-2 sm:grid-cols-3 gap-8 max-w-2xl place-items-center"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Button
            size="lg"
            className="px-8 py-4 font-medium border-0
